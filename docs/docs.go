...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/energy/cost": {
            "get": {
                "description": "Calculates the actual energy cost for a period, accounting for changing spot prices.\nGroups records into blocks of constant spot price, computes per-block kWh and cost,\nadds configured price components (transfer, energy tax, dynamic and static additions),\nand applies VAT.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.EnergyCostResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid start/stop parameter",
                    ...
                    "500": {
                        "description": "Failed to calculate energy cost",
                        "schema": {
                            "type": "string"
                        }
                    },
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/params.PersistentParam"
                            }
                        }
                    },
                    "500": {
                        "description": "Failed to get parameters",
                        "schema": {
                            "type": "string"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/params.CreateParamRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "Parameter with this key already exists",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/params/{key}": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Failed to get parameter",
                        "schema": {
                            "type": "string"
                        }
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/params.UpdateParamRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/solis": {
            "get": {
                "description": "Returns the most recent record from the \"solis\" InfluxDB bucket. household_load is\ncalculated from the power balance: solar_power - battery_power - grid_power, where\ngrid_power is positive when exporting and battery_power is positive when charging.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.SolisResponse"
                        }
                    },
                    "404": {
                        "description": "No Solis data found",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "500": {
                        "description": "Failed to query Solis data",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/solis/soc": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Aggregation window in minutes (e.g. 15)",
                        "name": "am",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.SOCDataPoint"
                            }
                        }
                    },
                    "400": {
                        "description": "Invalid start/stop/am parameter",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "500": {
                        "description": "Failed to query SOC data",
                        "schema": {
                            "type": "string"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.WeatherResponse"
                        }
                    },
                    "404": {
                        "description": "No weather data received yet",
                        "schema": {
                            "type": "string"
                        }
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.WeatherHistoryRecord"
                            }
                        }
                    },
                    "400": {
                    ...
                    "500": {
                        "description": "Failed to query weather data",
                        "schema": {
                            "type": "string"
                        }
                    },
    ...
    "definitions": {
        ...
        "api.EnergyCostBlock": {
            ...
            "properties": {
                ...
                "start": {
                    "type": "string",
                    "example": "2026-02-22T00:00:00+01:00"
                },
                "stop": {
                    "type": "string",
                    "example": "2026-02-22T01:00:00+01:00"
                },
                "total_price": {
                    "type": "number",
                    "example": 1.15
        ...
        "api.EnergyCostResponse": {
            "type": "object",
            "properties": {
                "blocks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.EnergyCostBlock"
                    }
                },
                "cost_before_vat": {
                    "type": "number",
                ...
                "period_stop": {
                    "type": "string",
                    "example": "2026-02-22T12:00:00+01:00"
                },
                "production_benefit": {
                    "type": "number",
                    "example": 5.67
        ...
        "api.SOCDataPoint": {
            ...
            "properties": {
                "timestamp": {
                    "type": "string",
                    "example": "2026-02-22T00:15:00+01:00"
                },
                "value": {
                    "type": "number",
                    "example": 78.5
        ...
        "api.WeatherResponse": {
            ...
            "properties": {
                "readings": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/api.WeatherReading"
                    }
                },
                "timestamp": {
                    "type": "string",
        ...
        "params.CreateParamRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Dynamic addition to price"
                },
                "key": {
                    "type": "string",
                    "example": "DynamicAddPrice"
                }
            }
        },
        "params.PersistentParam": {
            "type": "object",
            "properties": {
                "changed": {
                    "type": "string",
                    "example": "2026-01-15T10:30:00+01:00"
                },
                "content": {
                    "type": "string",
                    "example": "{\"value\": 0.04}"
